...
Therefore, by Corollary \ref{cor:alexander_root}, the dilatation $\lambda(\phi_h)$ must be the largest absolute value of a real root of the Alexander polynomial $\Delta_K(t) = (t^2-t+1)^2$. However, as established in the preceding section, $\Delta_K(t)$ has strictly complex roots and no real roots. Since, by geometric definition, the dilatation of a pseudo-Anosov map must satisfy $\lambda > 1$ (and thus be strictly real), we arrive at a contradiction.
