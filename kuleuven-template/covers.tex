...
\vspace{-\parskip}
\flushleft
\fontsize{45}{45}\selectfont \textcolor{bluetitle}{Folding Automata, Knot Floer Homology, and the Connect-Sum of Trefoils}\\[5.5mm]
...
\vspace{-\parskip}
\flushright
\fontsize{14}{16}\selectfont \textbf{Kevin YEH}
\end{textblock}
%
...
\vspace{-\parskip}
\flushright
A dissertation submitted to\\[4.5pt]
the Faculty of the Mathematics Department\\[4.5pt]
in partial fulfillment\\[4.5pt]
of the requirements for the degree of \\[4.5pt]
Doctor of Philosophy\\[4.5pt]
in Mathematics\\
\end{textblock}
%
