...
Train Track Map Candidate Family 5 of Track 17 is shown in Figure \ref{fig:track17_braid_b17_5_map}. See \ref{Boke_5} for details. This is a parametric family indexed by an integer twist parameter $k \in \mathbb{Z}_{\geq 0}$.
...
Train Track Map Candidate Family 6 of Track 17 is shown in Figure \ref{fig:track17_braid_b17_6_map}. See \ref{Boke_6} for details. This is a parametric family indexed by an integer twist parameter $k \in \mathbb{Z}_{\geq 0}$.
