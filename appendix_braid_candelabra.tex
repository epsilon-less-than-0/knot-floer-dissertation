...
Through the train track case analysis of the Candelabra (stratum $(3;1^6;3)$), we isolate exactly $19$ candidate families of train track maps for the one-click rotational state of the central triangle, listed as families $1, 1.1, 1.2, 2, 3, \ldots, 17$ below. The two-clicks rotational state is related to the one-click state by precomposition with the braid $G$ realizing one rotational click, as discussed in Appendix \ref{app:case_analysis_candelabra}; the resulting parallel families $1', 1.1', 1.2', 2', 3', \ldots, 17'$ are listed thereafter. If the pseudo-Anosov representative $\phi_\Phi$ has no interior fixed points, then its mapping class $\Phi$ must be conjugate to the lift of one of the following $38$ braid families (enumerated below with their twist parameters). 

\vspace{0.3cm}
\begingroup
\raggedbottom
\begin{description}
    \item[1.] $\displaystyle \Delta^{2i} \big( \allowbreak\sigma_{3}^{-1}\allowbreak\sigma_{4}^{-1}\allowbreak\sigma_{2}^{-1}\allowbreak\sigma_{3}^{-1}\allowbreak\sigma_{1}^{-1}\allowbreak\sigma_{2}^{-1}\allowbreak\sigma_{3}^{-1}\allowbreak\sigma_{4}^{-1}\allowbreak\sigma_{3}\allowbreak\sigma_{4}^{-1}\allowbreak\sigma_{5}^{-1}\allowbreak\sigma_{4}^{-1}\allowbreak\sigma_{3}^{-1}\allowbreak\sigma_{4}\allowbreak\sigma_{5}\allowbreak\sigma_{2}^{-1}\allowbreak\sigma_{1}^{-1}\allowbreak\sigma_{1}^{-1}\allowbreak\sigma_{2}^{-1}\allowbreak\sigma_{1}^{-1}\allowbreak\sigma_{1}^{-1} \cdot \allowbreak\sigma_{5}\allowbreak\sigma_{4}\allowbreak\sigma_{3}\allowbreak\sigma_{2}\allowbreak\sigma_{1}\allowbreak\sigma_{2}\allowbreak\sigma_{3}\allowbreak\sigma_{4}\allowbreak\sigma_{5}\allowbreak\sigma_{5}\allowbreak\sigma_{4}\allowbreak\sigma_{3}\allowbreak\sigma_{2}\allowbreak\sigma_{3}\allowbreak\sigma_{4}\allowbreak\sigma_{5}\allowbreak\sigma_{5}\allowbreak\sigma_{4}\allowbreak\sigma_{3}\allowbreak\sigma_{4}\allowbreak\sigma_{5}\allowbreak\sigma_{5}\allowbreak\sigma_{4}\allowbreak\sigma_{5}\allowbreak\sigma_{5} \big)^{-1}$
    ...
    \item[1.1.] $\displaystyle \Delta^{2i} \big( \allowbreak\sigma_{3}^{-1}\allowbreak\sigma_{2} \cdot G \big)^{-1}$
    \item[1.2.] $\displaystyle \Delta^{2i} \big( \allowbreak\sigma_{3}^{-k}\allowbreak\sigma_{2}^{m} \cdot G \big)^{-1}$
    \item[2.] $\displaystyle \Delta^{2i} \big( \allowbreak\sigma_{4}^{k}\allowbreak\sigma_{2}^{-1}\allowbreak\sigma_{3}^{-1}\allowbreak\sigma_{4} \cdot G \big)^{-1}$
    \item[3.] $\displaystyle \Delta^{2i} \big( \allowbreak\sigma_{5}\allowbreak\sigma_{4}^{-k} \cdot G \big)^{-1}$
    \item[4.] $\displaystyle \Delta^{2i} \big( \allowbreak\sigma_{5}^{-k}\allowbreak\sigma_{4} \cdot G \big)^{-1}$
    \item[5.] $\displaystyle \Delta^{2i} \big( \allowbreak\sigma_{5}^{-k}\allowbreak\sigma_{4}^{m}\allowbreak\sigma_{4}^{-1} \cdot G \big)^{-1}$
    \item[6.] $\displaystyle \Delta^{2i} \big( \allowbreak\sigma_{3}^{-k}\allowbreak\sigma_{2}\allowbreak\sigma_{3}\allowbreak\sigma_{4}^{-1}\allowbreak\sigma_{5}^{-1}\allowbreak\sigma_{4} \cdot G \big)^{-1}$
    \item[7.] $\displaystyle \Delta^{2i} \big( \allowbreak\sigma_{3}^{-k}\allowbreak\sigma_{2}\allowbreak\sigma_{3}\allowbreak\sigma_{4}^{-1}\allowbreak\sigma_{5}^{-1}\allowbreak\sigma_{4}^{m} \cdot G \big)^{-1}$
    \item[8.] $\displaystyle \Delta^{2i} \big( \allowbreak\sigma_{5}^{k}\allowbreak\sigma_{3}\allowbreak\sigma_{4}^{-1}\allowbreak\sigma_{5}^{-1} \cdot G \big)^{-1}$
    \item[9.] $\displaystyle \Delta^{2i} \big( \allowbreak\sigma_{5}^{m}\allowbreak\sigma_{3}\allowbreak\sigma_{4}^{-k}\allowbreak\sigma_{4}^{-1}\allowbreak\sigma_{5}^{-1} \cdot G \big)^{-1}$
    \item[10.] $\displaystyle \Delta^{2i} \big( \allowbreak\sigma_{5}^{-k}\allowbreak\sigma_{4}\allowbreak\sigma_{5}\allowbreak\sigma_{1}\allowbreak\sigma_{2}\allowbreak\sigma_{3}\allowbreak\sigma_{4} \cdot F \cdot G \big)^{-1}$
    \item[11.] $\displaystyle \Delta^{2i} \big( \allowbreak\sigma_{4}\allowbreak\sigma_{5}^{m}\allowbreak\sigma_{4}^{k}\allowbreak\sigma_{1}\allowbreak\sigma_{2}\allowbreak\sigma_{3}\allowbreak\sigma_{4} \cdot F \cdot G \big)^{-1}$
    \item[12.] $\displaystyle \Delta^{2i} \big( \allowbreak\sigma_{5}^{-k}\allowbreak\sigma_{4}\allowbreak\sigma_{5}\allowbreak\sigma_{1}\allowbreak\sigma_{2}\allowbreak\sigma_{1}\allowbreak\sigma_{3}\allowbreak\sigma_{2}\allowbreak\sigma_{4}\allowbreak\sigma_{3}\allowbreak\sigma_{4}\allowbreak\sigma_{4} \big)^{-1}$
    \item[13.] $\displaystyle \Delta^{2i} \big( \allowbreak\sigma_{5}\allowbreak\sigma_{1}\allowbreak\sigma_{2}\allowbreak\sigma_{1}\allowbreak\sigma_{3}\allowbreak\sigma_{2}\allowbreak\sigma_{4}\allowbreak\sigma_{3}\allowbreak\sigma_{4}\allowbreak\sigma_{4} \big)^{-1}$
    \item[14.] $\displaystyle \Delta^{2i} \big( \allowbreak\sigma_{5}^{k}\allowbreak\sigma_{3}^{m}\allowbreak\sigma_{1}\allowbreak\sigma_{2}\allowbreak\sigma_{3}\allowbreak\sigma_{4} \cdot F \cdot G \big)^{-1}$
    \item[15.] $\displaystyle \Delta^{2i} \big( \allowbreak\sigma_{2}\allowbreak\sigma_{1}\allowbreak\sigma_{3}\allowbreak\sigma_{2}\allowbreak\sigma_{5}\allowbreak\sigma_{4}\allowbreak\sigma_{3}\allowbreak\sigma_{4}\allowbreak\sigma_{4}\allowbreak\sigma_{5}^{-k}\allowbreak\sigma_{4} \big)^{-1}$
    \item[16.] $\displaystyle \Delta^{2i} \big( \allowbreak\sigma_{5}^{j}\allowbreak\sigma_{3}^{m}\allowbreak\sigma_{1}^{k} \cdot H \cdot G \big)^{-1}$
    \item[17.] $\displaystyle \Delta^{2i} \big( \allowbreak\sigma_{1}^{k}\allowbreak\sigma_{2}\allowbreak\sigma_{1}\allowbreak\sigma_{5}\allowbreak\sigma_{4}\allowbreak\sigma_{3}\allowbreak\sigma_{2}\allowbreak\sigma_{4}\allowbreak\sigma_{3}\allowbreak\sigma_{4}\allowbreak\sigma_{5}^{-m}\allowbreak\sigma_{4} \big)^{-1}$
    \item[$1'.$] $\displaystyle \Delta^{2i} \big( \allowbreak\sigma_{3}^{-1}\allowbreak\sigma_{4}^{-1}\allowbreak\sigma_{2}^{-1}\allowbreak\sigma_{3}^{-1}\allowbreak\sigma_{1}^{-1}\allowbreak\sigma_{2}^{-1}\allowbreak\sigma_{3}^{-1}\allowbreak\sigma_{4}^{-1}\allowbreak\sigma_{3}\allowbreak\sigma_{4}^{-1}\allowbreak\sigma_{5}^{-1}\allowbreak\sigma_{4}^{-1}\allowbreak\sigma_{3}^{-1}\allowbreak\sigma_{4}\allowbreak\sigma_{5}\allowbreak\sigma_{2}^{-1}\allowbreak\sigma_{1}^{-1}\allowbreak\sigma_{1}^{-1}\allowbreak\sigma_{2}^{-1}\allowbreak\sigma_{1}^{-1}\allowbreak\sigma_{1}^{-1} \cdot \allowbreak\sigma_{5}\allowbreak\sigma_{4}\allowbreak\sigma_{3}\allowbreak\sigma_{2}\allowbreak\sigma_{1}\allowbreak\sigma_{2}\allowbreak\sigma_{3}\allowbreak\sigma_{4}\allowbreak\sigma_{5}\allowbreak\sigma_{5}\allowbreak\sigma_{4}\allowbreak\sigma_{3}\allowbreak\sigma_{2}\allowbreak\sigma_{3}\allowbreak\sigma_{4}\allowbreak\sigma_{5}\allowbreak\sigma_{5}\allowbreak\sigma_{4}\allowbreak\sigma_{3}\allowbreak\sigma_{4}\allowbreak\sigma_{5}\allowbreak\sigma_{5}\allowbreak\sigma_{4}\allowbreak\sigma_{5}\allowbreak\sigma_{5} \cdot G \big)^{-1}$
    \item[$1.1'.$] $\displaystyle \Delta^{2i} \big( \allowbreak\sigma_{3}^{-1}\allowbreak\sigma_{2} \cdot G \cdot G \big)^{-1}$
    \item[$1.2'.$] $\displaystyle \Delta^{2i} \big( \allowbreak\sigma_{3}^{-k}\allowbreak\sigma_{2}^{m} \cdot G \cdot G \big)^{-1}$
    \item[$2'.$] $\displaystyle \Delta^{2i} \big( \allowbreak\sigma_{4}^{k}\allowbreak\sigma_{2}^{-1}\allowbreak\sigma_{3}^{-1}\allowbreak\sigma_{4} \cdot G \cdot G \big)^{-1}$
    \item[$3'.$] $\displaystyle \Delta^{2i} \big( \allowbreak\sigma_{5}\allowbreak\sigma_{4}^{-k} \cdot G \cdot G \big)^{-1}$
    \item[$4'.$] $\displaystyle \Delta^{2i} \big( \allowbreak\sigma_{5}^{-k}\allowbreak\sigma_{4} \cdot G \cdot G \big)^{-1}$
    \item[$5'.$] $\displaystyle \Delta^{2i} \big( \allowbreak\sigma_{5}^{-k}\allowbreak\sigma_{4}^{m}\allowbreak\sigma_{4}^{-1} \cdot G \cdot G \big)^{-1}$
    \item[$6'.$] $\displaystyle \Delta^{2i} \big( \allowbreak\sigma_{3}^{-k}\allowbreak\sigma_{2}\allowbreak\sigma_{3}\allowbreak\sigma_{4}^{-1}\allowbreak\sigma_{5}^{-1}\allowbreak\sigma_{4} \cdot G \cdot G \big)^{-1}$
    \item[$7'.$] $\displaystyle \Delta^{2i} \big( \allowbreak\sigma_{3}^{-k}\allowbreak\sigma_{2}\allowbreak\sigma_{3}\allowbreak\sigma_{4}^{-1}\allowbreak\sigma_{5}^{-1}\allowbreak\sigma_{4}^{m} \cdot G \cdot G \big)^{-1}$
    \item[$8'.$] $\displaystyle \Delta^{2i} \big( \allowbreak\sigma_{5}^{k}\allowbreak\sigma_{3}\allowbreak\sigma_{4}^{-1}\allowbreak\sigma_{5}^{-1} \cdot G \cdot G \big)^{-1}$
    \item[$9'.$] $\displaystyle \Delta^{2i} \big( \allowbreak\sigma_{5}^{m}\allowbreak\sigma_{3}\allowbreak\sigma_{4}^{-k}\allowbreak\sigma_{4}^{-1}\allowbreak\sigma_{5}^{-1} \cdot G \cdot G \big)^{-1}$
    \item[$10'.$] $\displaystyle \Delta^{2i} \big( \allowbreak\sigma_{5}^{-k}\allowbreak\sigma_{4}\allowbreak\sigma_{5}\allowbreak\sigma_{1}\allowbreak\sigma_{2}\allowbreak\sigma_{3}\allowbreak\sigma_{4} \cdot F \cdot G \cdot G \big)^{-1}$
    \item[$11'.$] $\displaystyle \Delta^{2i} \big( \allowbreak\sigma_{4}\allowbreak\sigma_{5}^{m}\allowbreak\sigma_{4}^{k}\allowbreak\sigma_{1}\allowbreak\sigma_{2}\allowbreak\sigma_{3}\allowbreak\sigma_{4} \cdot F \cdot G \cdot G \big)^{-1}$
    \item[$12'.$] $\displaystyle \Delta^{2i} \big( \allowbreak\sigma_{5}^{-k}\allowbreak\sigma_{4}\allowbreak\sigma_{5}\allowbreak\sigma_{1}\allowbreak\sigma_{2}\allowbreak\sigma_{1}\allowbreak\sigma_{3}\allowbreak\sigma_{2}\allowbreak\sigma_{4}\allowbreak\sigma_{3}\allowbreak\sigma_{4}\allowbreak\sigma_{4} \cdot G \big)^{-1}$
    \item[$13'.$] $\displaystyle \Delta^{2i} \big( \allowbreak\sigma_{5}\allowbreak\sigma_{1}\allowbreak\sigma_{2}\allowbreak\sigma_{1}\allowbreak\sigma_{3}\allowbreak\sigma_{2}\allowbreak\sigma_{4}\allowbreak\sigma_{3}\allowbreak\sigma_{4}\allowbreak\sigma_{4} \cdot G \big)^{-1}$
    \item[$14'.$] $\displaystyle \Delta^{2i} \big( \allowbreak\sigma_{5}^{k}\allowbreak\sigma_{3}^{m}\allowbreak\sigma_{1}\allowbreak\sigma_{2}\allowbreak\sigma_{3}\allowbreak\sigma_{4} \cdot F \cdot G \cdot G \big)^{-1}$
    \item[$15'.$] $\displaystyle \Delta^{2i} \big( \allowbreak\sigma_{2}\allowbreak\sigma_{1}\allowbreak\sigma_{3}\allowbreak\sigma_{2}\allowbreak\sigma_{5}\allowbreak\sigma_{4}\allowbreak\sigma_{3}\allowbreak\sigma_{4}\allowbreak\sigma_{4}\allowbreak\sigma_{5}^{-k}\allowbreak\sigma_{4} \cdot G \big)^{-1}$
    \item[$16'.$] $\displaystyle \Delta^{2i} \big( \allowbreak\sigma_{5}^{j}\allowbreak\sigma_{3}^{m}\allowbreak\sigma_{1}^{k} \cdot H \cdot G \cdot G \big)^{-1}$
    \item[$17'.$] $\displaystyle \Delta^{2i} \big( \allowbreak\sigma_{1}^{k}\allowbreak\sigma_{2}\allowbreak\sigma_{1}\allowbreak\sigma_{5}\allowbreak\sigma_{4}\allowbreak\sigma_{3}\allowbreak\sigma_{2}\allowbreak\sigma_{4}\allowbreak\sigma_{3}\allowbreak\sigma_{4}\allowbreak\sigma_{5}^{-m}\allowbreak\sigma_{4} \cdot G \big)^{-1}$
\end{description}
\endgroup
...
\section{Candidate 1.1}\label{sec:braid_1.1}
Train Track Map Candidate 1.1 of the Candelabra train track is shown in Figure \ref{fig:candelabra_braid_b1.1_map}. See Section \ref{Jehu} of Appendix \ref{app:case_analysis_candelabra} for details.

\begin{figure*}[ht]
    \centering
    \includegraphics[width=\linewidth, height=0.45\textheight, keepaspectratio]{figures_braid/figures_candelabra/Candelabra Braid 1.1 Jehu-1.jpg}
    \caption{Train Track Map Candidate 1.1 of the Candelabra.}
    \label{fig:candelabra_braid_b1.1_map}
\end{figure*}

The inverse of the following braid carries this train track map:
\[
b_{1.1}^c = \sigma_3^{-1}\sigma_2 \circ G
\]
where $G$ is the braid of Section \ref{sec:braid G}. This is shown in Figure \ref{fig:candelabra_braid_b1.1}.

\begin{figure*}[p]
    \centering
    \includegraphics[width=\linewidth, height=0.45\textheight, keepaspectratio]{figures_braid/figures_candelabra/Candelabra Braid 1.1 Jehu-2.jpg}
    \caption{This sequence shows the inverse of the braid $b_{1.1}^c$ carries Train Track Candidate 1.1.}
    \label{fig:candelabra_braid_b1.1}
\end{figure*}

\clearpage

\section{Candidate Family 1.2}\label{sec:braid_1.2}
Train Track Map Candidate Family 1.2 of the Candelabra train track is shown in Figure \ref{fig:candelabra_braid_b1.2_map}. Note there is twisting between $\fbo$ between $i$ and $s$, and additional twisting between $\fbr$ and $\fbb$. See Section \ref{Jehu} of Appendix \ref{app:case_analysis_candelabra} for details.

\begin{figure*}[ht]
    \centering
    \includegraphics[width=\linewidth, height=0.45\textheight, keepaspectratio]{figures_braid/figures_candelabra/Candelabra Braid 1.2 Jehu-1.jpg}
    \caption{Train Track Map Candidate Family 1.2 of the Candelabra.}
    \label{fig:candelabra_braid_b1.2_map}
\end{figure*}

The inverse of the following braid carries this family of train track maps:
\[
b_{1.2}^c = \sigma_3^{-k}\sigma_2^m \circ G
\]
where $G$ is the braid of Section \ref{sec:braid G}, and $k, m \geq 1$ ($k, m \in \mathbb{Z}$) are the twisting parameters. This is shown in Figure \ref{fig:candelabra_braid_b1.2}.

\begin{figure*}[p]
    \centering
    \includegraphics[width=\linewidth, height=0.45\textheight, keepaspectratio]{figures_braid/figures_candelabra/Candelabra Braid 1.2 Jehu-2.jpg}
    \caption{This sequence shows the inverse of the braid $b_{1.2}^c$ carries Train Track Candidate Family 1.2.}
    \label{fig:candelabra_braid_b1.2}
\end{figure*}
