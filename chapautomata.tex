...
\begin{figure}[H]
    ...
    \caption{Left: A left-to-right folding at the cusp located at $v_cusp$. Right: The equivalent operation performed by the algorithm on a \texttt{StandardTrainTrack} object. The algorithm deletes $e_L$, then attach a new edge between $v_L$ and $v_far$ at the appropriate position in the cyclic ordering. The graph information, cyclic ordering, and cusp informations are updated for the newly created \texttt{StandardTrainTrack} object.}
