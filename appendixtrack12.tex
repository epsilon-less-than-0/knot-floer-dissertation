...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figures_case_analysis/track12_case_analysis/Track 12.jpg}
    \caption{Track 12
    \label{fig:track12}}
\end{figure}
...
Here we claim that the dotted lines must join in the middle. Indeed, if they did not, then in order to not put either $\fbd$ or $\fbdb$ in Situation $\beta$, this can only occur with $\fbdb$ going below $\fbr$, or $\fbp$ going above $\fbd$. In the former case, this causes $\fbp$ to trace, as shown in Figure \ref{fig:BKG2}. In the latter case, the dotted lines will be in Situation $\alpha$, as shown in Figure \ref{fig:BKG3}.

Thus the dotted lines must join, so we have Figure \ref{fig:BKG4}.

Now let us assume that there were no initial twists by $\fbdb$. Then $\fbr$ will trace, as shown in Figure \ref{fig:BKG5}.

So let us assume instead that $\fbdb$ has initial twists with $o$. 

But this means $\fbo$ will trace, as shown in Figure \ref{fig:BKG6}.
...
% The latter case is shown in BKG7. Here the dotted lines are forced to join, otherwise $\fbd$ will violate the Trace Lemma.
...
This is Figure \ref{fig:CNM1}.

Here if $\fbdb$ were to begin with $i^+$ then it must continue with $p^+$ otherwise $\fbi$ would immediately trace. Moreover, $\fbdb$ must join with $\fbd$ here or $\fbd$ would be in Situation $\beta$. So in this scenario we have Figure \ref{fig:CNM2}.
...
Here $\fbs$ cannot go into 2, otherwise it will escape to the outer perimeter and eventually trace due to the position of $\fbr$. So it goes into 1, which is Figure \ref{fig:CNM3}.
...
\fbs = ...b^- r^- d...
\]
This is Figure \ref{fig:CNM4}. But here $\fbs$ escapes to the outer perimeter again and will eventually trace.

So suppose instead that $\fbb$ began with $r^-$, as in Figure \ref{fig:CNM5}.
...
This is Figure \ref{fig:CNM6}.

Here again we must have
\[
\fbs = ...b^- r^- d...
\]
and $\fbs$ will escape to the outer perimeter and trace, as shown in Figure \ref{fig:CNM7}.

So suppose $\fbb$ went into 2. Then we have the situation depicted in Figure \ref{fig:CNM8}. Here $\fbi$, $\fbs$, and $\fbb$ are stuck in a three-way counterclockwise path mill between $\fbb$, and $\fbp$. This is a contradiction.

So going back to the situation depicted in Figure \ref{fig:CNM1}, suppose $\fbdb$ began with $i^-$, then
\[
\fbdb = i^- o^*...
\]
...
\subsection{LGU}\label{LGU}
Suppose $\fbd$ began with $b$, and $\fbdb$ began with $p$. Then $\fbdb$ must begin with $p^-$, as shown in Figure \ref{fig:LGU1}; and then it must traverse either $i^- \dbar$, or $s^- \dbar$. In either case, this would cause the dotted lines to be in Situation $\alpha$, as shown in Figure \ref{fig:LGU2}, and Figure \ref{fig:LGU3}.
...
\subsection{SXM}\label{SXM}
Suppose $\fbd$ began with $r$, and $\fbdb$ began with $p$. Then we have the situation depicted in Figure \ref{fig:SXM1}.
...
\fbb = d p^- i^- o^*...
\]
as shown in Figure \ref{fig:SXM2}.
...
This is Figure \ref{fig:SXM3}, where again $\fbb$ must go above $\fbdb$ for the same reason as before, and the dotted lines must join in the middle otherwise one of them will immediately enter Situation $\beta$.
...
This is Figure \ref{fig:SXM6}.

Here consider $\fbr$. It can either begin with $b^\circ$ or $b^+$. Suppose it were the former. This is Figure \ref{fig:SXM7}. 
...
But now $\fbo$ will trace as shown in Figure \ref{fig:SXM9}.

\subsection{GIB}\label{GIB}
Suppose $\fbd$ began with $r$, and $\fbdb$ began with $i$. Then we have the situation depicted in Figure \ref{fig:GIB1}.
...
In the former case, this causes $\fbp$ to trace, as shown in Figure \ref{fig:GIB2}. In the latter case, the dotted lines will enter Situation $\alpha$, as shown in Figure \ref{fig:GIB3}.

So the dotted lines must join. But in this case $\fbp$ still trace, as shown in Figure \ref{fig:GIB4}.

This is a contradiction.

\subsection{TEX}
Suppose $\fbd$ began with $r$, and $\fbdb$ began with $s$. Then we have the situation depicted in Figure \ref{fig:GIB1}. As in the situation in GIB \ref{GIB}, $\fbdb$ must eventually traverse $p^+$ right before crossing.
...
This is Figure \ref{fig:XNA2}.

Here $\fbdb$ must continue with $p^-$ after crossing to not violate the Trace Lemma.
...
But now as Figure \ref{fig:XNA4} shows, $\fbo$ will trace.
...
This is Figure \ref{fig:WYS1}.

The same arguments used in XNA \ref{XNA} lead to the conclusion that $\fbs$ must begin with $b^+$, but in this instance this means it will immediately trace after crossing, as shown in Figure \ref{fig:WYS2}.
...
In this case, $\fbp$ is forced to immediately trace after crossing, as shown in Figure \ref{fig:HTI1}.
...
We have the situation depicted in Figure \ref{fig:SEZ2}.
...
But now we have the situation depicted in Figure \ref{fig:SEZ3}, where it is clear that $\fbo$ will trace.

So suppose instead $\fbp$ continued with $s$:
\[
\fbp = d s^*...
\]
and if $\fbr$ also began with $s$ here we would have Figure \ref{fig:SEZ4}. Here the same argument as before shows the dotted liens must join. Here $\fbi$ and $\fbo$ must continue with $p^-$ otherwise $\fbb$ would trace after crossing; but then one of $\fbo$ or $\fbi$ will trace.

If $\fbr$ instead began with $i$, then this is the situation depicted in Figure \ref{fig:SEZ5}. Here again $\fbi$ and $\fbo$ must continue with $p^-$ otherwise $\fbb$ would trace after crossing; but then one of $\fbo$ or $\fbi$ will trace.
...
\fbo = b^- r^- d...
\]
as shown in Figure \ref{fig:PBH1}.
...
This is Figure \ref{fig:TRK1}.

Then Figure \ref{fig:TRK2} is immediate.
...
On the other hand, if $\fbb$ were to begin with $p^+$, then in order to not trace, it can only do so by going in between $\fbdb$ and $\fbi$, as shown in Figure \ref{fig:TRK3}.
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track12_case_analysis/BKG-1.jpg}
    \caption{BKG1}
    \label{fig:BKG1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track12_case_analysis/BKG-2.jpg}
    \caption{BKG2}
    \label{fig:BKG2}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track12_case_analysis/BKG-3.jpg}
    \caption{BKG3}
    \label{fig:BKG3}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track12_case_analysis/BKG-4.jpg}
    \caption{BKG4}
    \label{fig:BKG4}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track12_case_analysis/BKG-5.jpg}
    \caption{BKG5}
    \label{fig:BKG5}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track12_case_analysis/BKG-6.jpg}
    \caption{BKG6}
    \label{fig:BKG6}
\end{figure}
\clearpage
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track12_case_analysis/CNM-1.jpg}
    \caption{CNM1}
    \label{fig:CNM1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track12_case_analysis/CNM-2.jpg}
    \caption{CNM2}
    \label{fig:CNM2}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track12_case_analysis/CNM-3.jpg}
    \caption{CNM3}
    \label{fig:CNM3}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track12_case_analysis/CNM-4.jpg}
    \caption{CNM4}
    \label{fig:CNM4}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track12_case_analysis/CNM-5.jpg}
    \caption{CNM5}
    \label{fig:CNM5}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track12_case_analysis/CNM-6.jpg}
    \caption{CNM6}
    \label{fig:CNM6}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track12_case_analysis/CNM-7.jpg}
    \caption{CNM7}
    \label{fig:CNM7}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track12_case_analysis/CNM-8.jpg}
    \caption{CNM8}
    \label{fig:CNM8}
\end{figure}
\clearpage
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track12_case_analysis/LGU-1.jpg}
    \caption{LGU1}
    \label{fig:LGU1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track12_case_analysis/LGU-2.jpg}
    \caption{LGU2}
    \label{fig:LGU2}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track12_case_analysis/LGU-3.jpg}
    \caption{LGU3}
    \label{fig:LGU3}
\end{figure}
\clearpage
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track12_case_analysis/SXM-1.jpg}
    \caption{SXM1}
    \label{fig:SXM1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track12_case_analysis/SXM-2.jpg}
    \caption{SXM2}
    \label{fig:SXM2}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track12_case_analysis/SXM-3.jpg}
    \caption{SXM3}
    \label{fig:SXM3}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track12_case_analysis/SXM-4.jpg}
    \caption{SXM4}
    \label{fig:SXM4}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track12_case_analysis/SXM-5.jpg}
    \caption{SXM5}
    \label{fig:SXM5}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track12_case_analysis/SXM-6.jpg}
    \caption{SXM6}
    \label{fig:SXM6}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track12_case_analysis/SXM-7.jpg}
    \caption{SXM7}
    \label{fig:SXM7}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track12_case_analysis/SXM-8.jpg}
    \caption{SXM8}
    \label{fig:SXM8}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track12_case_analysis/SXM-9.jpg}
    \caption{SXM9}
    \label{fig:SXM9}
\end{figure}
\clearpage
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track12_case_analysis/GIB-1.jpg}
    \caption{GIB1}
    \label{fig:GIB1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track12_case_analysis/GIB-2.jpg}
    \caption{GIB2}
    \label{fig:GIB2}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track12_case_analysis/GIB-3.jpg}
    \caption{GIB3}
    \label{fig:GIB3}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track12_case_analysis/GIB-4.jpg}
    \caption{GIB4}
    \label{fig:GIB4}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track12_case_analysis/TGU.jpg}
    \caption{TGU1}
    \label{fig:TGU1}
\end{figure}
\clearpage
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track12_case_analysis/XNA-1.jpg}
    \caption{XNA1}
    \label{fig:XNA1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track12_case_analysis/XNA-2.jpg}
    \caption{XNA2}
    \label{fig:XNA2}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track12_case_analysis/XNA-3.jpg}
    \caption{XNA3}
    \label{fig:XNA3}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track12_case_analysis/XNA-4.jpg}
    \caption{XNA4}
    \label{fig:XNA4}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track12_case_analysis/WYS-1.jpg}
    \caption{WYS1}
    \label{fig:WYS1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track12_case_analysis/WYS-2.jpg}
    \caption{WYS2}
    \label{fig:WYS2}
\end{figure}
\clearpage
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track12_case_analysis/HTI.jpg}
    \caption{HTI1}
    \label{fig:HTI1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track12_case_analysis/SEZ-1.jpg}
    \caption{SEZ1}
    \label{fig:SEZ1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track12_case_analysis/SEZ-2.jpg}
    \caption{SEZ2}
    \label{fig:SEZ2}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track12_case_analysis/SEZ-3.jpg}
    \caption{SEZ3}
    \label{fig:SEZ3}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track12_case_analysis/SEZ-4.jpg}
    \caption{SEZ4}
    \label{fig:SEZ4}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track12_case_analysis/SEZ-5.jpg}
    \caption{SEZ5}
    \label{fig:SEZ5}
\end{figure}
\clearpage
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track12_case_analysis/PBH.jpg}
    \caption{PBH1}
    \label{fig:PBH1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track12_case_analysis/TRK-1.jpg}
    \caption{TRK1}
    \label{fig:TRK1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track12_case_analysis/TRK-2.jpg}
    \caption{TRK2}
    \label{fig:TRK2}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track12_case_analysis/TRK-3.jpg}
    \caption{TRK3}
    \label{fig:TRK3}
\end{figure}
