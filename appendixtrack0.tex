...
\label{app:case analysis track0}
...
Back to the end of Case A \ref{CaseA}. Consider the case of $\fbd$ starts at $b$, and $\fbdb$ starts at $s$. Here $\fbd$ has to start with
\[
\fbd = b^- p^- d...
\]
...
Back to the end of Case A \ref{CaseA}. Consider the case of $\fbd$ starting at $b$, and $\fbdb$ starting at $i$. Then again $\fbd$ has to start with
\[
\fbd = b^- p^- d...
\]
...
\subsection{Lake}
back to the end of Case A \ref{CaseA}. Consider the case of $\fbd$ starting at $p$ and $\fbdb$ starting at $s$.
...
This is a main section (level 1).

\subsection{Subsection}
This is a subsection (level 2).

\subsubsection{Subsubsection}
This is a subsubsection (level 3).

\subsubsubsection{Subsubsubsection}
This is a subsubsubsection (level 4).

\subsubsubsubsection{Subsubsubsubsection}
This is a subsubsubsubsection (level 5).

\subsubsubsubsubsection{Subsubsubsubsubsection}
This is a subsubsubsubsubsection (level 6).

\subsubsubsubsubsubsection{Subsubsubsubsubsubsection}

\subsubsubsubsubsubsubsection{Subsubsubsubsubsubsubsection}

Some content at the deepest level.

\section{Another Main Section}
Demonstrating the hierarchy again.
...
\subsubsubsection{Another Subsubsubsection}
Even more content.

\subsubsubsubsection{Another Subsubsubsubsection}
Getting quite deep now.

\subsubsubsubsubsection{Another Subsubsubsubsubsection}
At the deepest level again.
