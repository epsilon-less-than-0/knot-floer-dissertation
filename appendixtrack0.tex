...
\fbd = r^- p^- d...
\]
as depicted in Figure \ref{fig:AVX2}.
...
Suppose $\fbr$ begins with $p^-$. Then we have Figure \ref{fig:Phil1}.
...
This is Figure \ref{fig:Bibble1}.

\subsubsubsubsubsection{Bawcock}\label{Bawcock}
Suppose $f_\beta(i)$ continue with $r^*$. Then the following is forced:

Figure \ref{fig:Bawcock1}.
...
\subsubsubsubsubsection{Chaffer}\label{Chaffer}
Back to the end of Bibble \ref{Bibble}. Suppose $f_\beta(i)$ continues with $b^*$. 

This is Figure \ref{fig:Chaffer1}.
...
This forces the situation depicted in Figure \ref{fig:Chaffer2}.
...
This is Figure \ref{fig:Chaffer3}.
...
\]
as shown in Figure \ref{fig:Chaffer4}.
...
\subsubsubsubsection{Jargle}\label{Jargle}
Back to the end of Linen \ref{Linen}. Suppose dotted lines do not join, and suppose $\fbd$ goes into 3. 

Then the situation is shown in Figure \ref{fig:Jargle1}.

Where $\fbd$ must continue with $p^+$ after crossing $d$ and not $o$ to not violate the Trace Lemma.

Here $\fbd$ continues with $\dbar p^+$, and the next letter cannot be $b^*$ or it would violate the Trace Lemma. So the next letter must be $r^+$, and then:
\[
\fbdb = s^- i^- \dbar p^+ \hat{r}^+ d o^+...
\]
where it just violated the Trace Lemma.

This is a contradiction.

\subsubsubsection{Kench}\label{Kench}
Back to \ref{Phil} Phil. Suppose $\fbdb$ continues with $o^-$. 

This is Figure \ref{fig:Kench1}.
...
So $\fbdb$ msut go below $\fbp$ to give the situation in Figure \ref{fig:Kench2}.
...
This is Figure \ref{fig:Limmer1}.
...
\subsubsubsubsubsection{Costard}\label{Costard}
Suppose 
\[
\fbi = \dbar p^+ r^*...
\]
...
This is Figure \ref{fig:Costard1}.
...
So we have the situation depicted in Figure \ref{fig:Daddock1}.
...
\fbs = i^\circ
\]
\subsubsubsubsubsubsection{Cordwain}\label{Cordwain}
Suppose 
\[
\fbs = i^-...
\]
...
This is Figure \ref{fig:Cordwain1}.
...
This is Figure \ref{fig:Cordwain2}.
...
The situation now is shown in Figure \ref{fig:Loblolly1}.
...
This is Figure \ref{fig:Loblolly2}.
...
This gives Candidate 1. Shown in Figure \ref{fig:Loblolly3}.

\subsubsubsubsection{Smouch}\label{Smouch}
Back to the end of Pugil \ref{Pugil}. Suppose $\fbs$ goes into 1.

This is Figure \ref{fig:Smouch1}.
...
\subsubsubsubsection{Thwite}\label{Thwite}
...
as shown in Figure \ref{fig:Thwite1}.

At this point neither of these can go up $b$, as that will force them to violate the Trace Lemma. Hence both have to continue clockwise, with $...r^+ d o...$. 

But then they will cross $d$ and then traverse $o^+ \dbar$, thereby violating the Trace Lemma.

This is a contradiction.

\subsubsubsection{Quarl} \label{Quarl}
Back to end of Test \ref{Test}. Suppose $\fbdb$ continue with $o^-$, so we have the situation shown in Figure \ref{fig:Quarl1}.
...
\subsubsubsubsection{Yaffle}\label{Yaffle}
...
Giving us Figure \ref{fig:Yaffle1}.
...
The situation is shown in Figure \ref{fig:ACK1}.
...
The situation now is depicted in Figure \ref{fig:Sloom3}.
...
\]
as shown in Figure \ref{fig:Sloom4}.
...
as shown in Figure \ref{fig:Sloom5}.
...
This is Figure \ref{fig:Dwammy1}.
...
\fbo = s^+ \dbar p^+ r^+ p*...
\]
This is Figure \ref{fig:Dwammy2}.
...
\fbo = s^+ \dbar p^+ r^+ p^-...
\]
This situation is depicted in Figure \ref{fig:Dwammy3}, and here $\fbo$ can go into 1 or 2 (it cannot go into the left of $\fbr$ as that would again force $\fbr$ to immediately trace).

\subsubsubsubsubsection{Macarize}\label{Macarize}
...
This is Figure \ref{fig:Macarize1}.
...
The situation is depicted in Figure \ref{fig:Mooncalf1}.
...
This is Figure \ref{fig:Mooncalf2}.
...
This is Figure \ref{fig:Mooncalf3}.
...
This is Figure \ref{fig:Mooncalf4}.
...
This is Figure \ref{fig:Mooncalf5}.
...
This is Figure \ref{fig:Mooncalf6}.
...
This is Figure \ref{fig:Mooncalf7}.
...
This is Figure \ref{fig:Mooncalf8}.
...
In conclusion, we have Candidate 3 shown in Figure \ref{fig:Mooncalf9}.

\subsubsubsubsection{Faffel}\label{Faffel}
Back to the end of Thrum (\ref{Thrum}). Suppose $\fbi = s^\circ$. This is depicted in Figure \ref{fig:Faffel1}.
...
Now the situation is depicted in Figure \ref{fig:Faffel2}.
...
This is depicted in Figure \ref{fig:Faffel3}.
...
This is depicted in Figure \ref{fig:Faffel4}.
...
\]
This is depicted in Figure \ref{fig:Faffel5}. 
...
This is depicted in Figure \ref{fig:Faffel6}.
...
Therefore, in the situation depicted in Figure \ref{fig:Faffel6}, $\fbb$ has to start with $p^+$, and this forces $\fbr$ to end at $p$ immediately in order to not trace or be absorbed:
\[
\fbr = p^\circ
\]
and $\fbb$ continues:
...
\fbb = p^+ r^- p^- d s^- i^*...
\]
Now the situation is depicted in Figure \ref{fig:Faffel7}.
...
So in this situation depicted in Figure \ref{fig:Faffel7}, $\fbb$ must continue with $i^-$, and to the right of $\fbo$, otherwise $\fbo$ will still be absorbed. But now $\fbb$ traces:
\[
\fbb = p^+ r^- p^- d s^- \hat{i}^- s^+ \dbar p^+ r^+ p^- d i^+ s^+ \dbar p^+ b^\times
\]

Therefore, we can conclude that in the situation depicted in Figure \ref{fig:Faffel4}, $\fbo$ must end there at $b^\circ$. 

Now the situation depicted in Figure \ref{fig:Faffel8} is forced.
...
\fbr = p^- d i^+ s^+ \dbar p^+ b^+ p^- d s^- i^- \dbar p^+ r\times
\]
Therefore, we must have, in the situation depicted in Figure \ref{fig:Faffel8}, $\fbr$ starts and ends at $p^\circ$:
\[
\fbr = p^\circ
\]
...
\fbb = p^+ r^- p^- d s^- i^*...
\]
This is depicted in Figure \ref{fig:Faffel9}.
...
In conclusion, in the situation depicted in Figure \ref{fig:Faffel9}, $\fbb$ must end there at $i^\circ$:
\[
\fbb = p^+ r^- p^- d s^- i^\circ
\]

This gives us our Candidate train track map 4. Depicted in Figure \ref{fig:Faffel10}.

\subsubsection{Lugs}\label{Lugs}
Back to end of ACK (\ref{ACK}). Suppose $\fbd$ go into 1.

The situation is depicted in Figure \ref{fig:Lugs1}. 
...
This is depicted in Figure \ref{fig:Lugs2}.

This is a contradiction.

\subsubsection{Haze}\label{Haze}
Back to end of ACK (\ref{ACK}). Suppose $\fbd$ goes into 2. 

The situation is depicted in Figure \ref{fig:Haze1}. 
...
Now we are at Figure \ref{fig:Haze2}.
...
Back to the end of Case A \ref{CaseA:Track0}. Consider the case of $\fbd$ starts at $r$, and $\fbdb$ starts at $o$. This is Figure \ref{fig:Quip1}. Again $\fbd$ has to start with
\[
\fbd = r^- p^- d...
\]
to not violate Assumption A. Similarly, $\fbdb$ must start with
\[
\fbdb = o^+ s^- \dbar...
\]
The situation is depicted in Figure \ref{fig:Quip1}.
...
\fbd = b^- p^- d...
\]
to not violate Assumption A, since if it were to start with $b^+$, then the next letter will have to be $d$.
...
We are now in Figure \ref{fig:Zest1}.

Consider $\fbdb$. It must start with $s^-$, in order to not immediately violate Assumption A. There are two choices after the initial letter:
\[
\fbdb = s^- i^-...
\]
or
...
\fbdb = s^- o^-...
\]
Here, both $i$ and $o$ can only be clockwise because otherwise the third and fourth letters will be forced to be $s^+\dbar$, which contradicts the Trace Lemma.

\subsubsection{Omen}\label{Omen}
Suppose $\fbdb =  s^- i^-...$. 

This is Figure \ref{fig:Omen1}. 

Here $\fbd$ can go into 1, 2, or 3, or it can join with $\fbdb$. 

If it were to go into 1, then we have Figure \ref{fig:Omen2}. But now neither of the dotted lines can ever go up to $p$, or else we will be in Situation $\beta$. This means both of them will continue with $r^\pm$, or $b^0$ and continue circling clockwise. The former will violate Assumption A, as right after $r^\pm$ has to be $d$. On the other hand, the latter results in Situation $\alpha$. Thus $\fbd$ cannot go into 1.

If it were to go into 2, then we are immediately in Situation $\beta$.

Suppose it were to go into 3. Then then next letter cannot be $o^\pm$, since the letter after that would have to be $\dbar$, which would violate Assumption A. So then it continues with $i^+$:
\[
\fbd = b^- p^- d i^+ s^+ \dbar p^+ b^+ d i^+...
\]
again here at the end it has to be $i^+$ and not $o^\pm$ for the same reason.

This is Figure \ref{fig:Omen3}.
...
This is shown in Figure \ref{fig:Omen4}.

This is a contradiction.

Therefore, going back to Figure \ref{fig:Omen1}, we must have the dotted lines join in the middle. This is Figure \ref{fig:Omen5}.
...
\subsubsection{Axe}\label{Axe}
Back to the end of Zest (\ref{Zest}). Suppose 
\[
\fbdb = s^- o^-...
\]

This is Figure \ref{fig:Axe1}.
...
\fbd = b^- p^- d \hat{s}^-...
\]
and here the next letter can either be $i^\pm$ or $o^-$. This is Figure \ref{fig:Axe2}.

However, $i^\pm$ will cause $\fbd$ to violate Assumption A:
\[
...
This is Figure \ref{fig:Axe3}.

But now we are in Situation $\alpha$. Indeed, the next letter for $\fbd$ and $\fbdb$ can either be $r\pm$ or $b^-$. But the former necessitates $d$ to immediately follow. Thus it has to be $b^-$. But then both $\fbd$ continues in the outer perimeter, coming back to $\dbar$, repeating indefinitely.
...
\fbd = b^- p^- d...
\]
to not violate Assumption A; and similarly, $\fbdb$ has to start with
\[
\fbdb = i^+ s^+ \dbar...
\]
...
The situation is depicted in Figure \ref{fig:Lox1}.
...
Suppose the dotted lines join. This is depicted in Figure \ref{fig:Lava1}.
...
We are now in Figure \ref{fig:Query1}.
...
\subsubsubsubsubsection{Depth}\label{Depth}
...
\]
This is depicted in Figure \ref{fig:Depth3}.
...
We are now in the situation depicted in Figure \ref{fig:Kiosk3}.
...
This is Figure \ref{fig:Kiosk5}.

Now here $\fbo$ can continue with $r^*$ or $b^-$.

\subsubsubsubsubsubsection{Abacus}\label{Abacus}
...
This is Figure \ref{fig:Abacus1}.
...
This is Figure \ref{fig:Abacus2}.
...
This is Figure \ref{fig:Abacus4}. 
...
\subsubsubsubsubsubsection{Banana}\label{Banana}
...
This is Figure \ref{fig:Banana1}.
...
This is Figure \ref{fig:Banana2}. 
...
This is show in Figure \ref{fig:Banana3}.

This is a contradiction.

\subsubsubsubsection{Cloud}\label{Cloud}
Back to the end of Query \ref{Query}. Suppose $\fbo = s^-$ goes into 3. 

This is Figure \ref{fig:Cloud1}.
...
\]
This is Figure \ref{fig:Cloud3}.

This is a contradiction.

\subsubsubsection{Bold}
Back to the end of Lava \ref{Lava}. Suppose $\fbp$ goes below $\fbs$. Here notice that the (partial) train track map as depicted in Figure \ref{fig:Lava1} is symmetrical. Thus in all the previous arguments for the non-existence of a suitable train track map, for the case of $\fbp$ continuing above $\fbs$, we can make the appropriate substitutions to adapt them into arguments for the non-existence of a suitable train track map, for the case of $\fbp$ continuing below $\fbs$.
...
This is Figure \ref{fig:Drop1}.

Now the next letter for $\fbd$ cannot be $r^*$, as the letter after that would have to be $d$, so the Trace Lemma would be violated. Thus the next letter is either $b^-$ or $p^*$. If it were $b^-$ then it continues:
\[
...
\fbd = b^- p^- d...
\]
and the next letter can be $i^+$ or $o^*$, but if it were the latter then the letter after that would have to be $\dbar$ which would violate the Trace Lemma. Thus the next letter has to be $i^+$:
\[
\fbd = b^- p^- d i^+...
\]
This is Figure \ref{fig:Rage1}.
...
This is shown in Figure \ref{fig:Rage2}.

This is a contradiction.

\subsection{Lake}\label{Lake}
back to the end of Case A \ref{CaseA:Track0}. Consider the case of $\fbd$ starting at $p$ and $\fbdb$ starting at $s$.

The situation is depicted in Figure \ref{fig:Lake1}.

Here $\fbd$ has to start with $p^+$ in order to not immediately go over $d$ after $p$, which would violate Assumption A. So we have
\[
\fbd = p^+...
\]
...
\fbdb = s^-...
\]
in order to not immediately violate Assumption A.
...
\fbd = p^+ b^*...
\]
Here we claim that the second letter has to be $b^+$. Indeed, if it were $b^-$, then the Trace Lemma will be violated again, as we would have $\fbd = p^+ b^- d...$. Thus we must have
\[
\fbd = p^+ b^+...
\]
...
This is depicted in Figure \ref{fig:Join1}.
...
Then in fact it has to be $i^-$, as if it were $i^+$ the Trace Lemma will be violated:
\[
\fbdb = s^- i^+ s^+ \dbar...
\]
...
This is shown in Figure \ref{fig:Jolly2}.
...
This is shown in Figure \ref{fig:Jolly3}.


Therefore, in the situation depicted in Figure \ref{fig:Jolly1}, the dotted lines must join. 

This is Figure \ref{fig:Jolly4}.

But now the $\fbr$ and $\fbb$ pair on the left has to either go above or below the $\fbo$ and $\fbi$ pair on the right. If the left pair goes above the right pair, then this again leads to $\fbb$ tracing, identical to the situation before. This is depicted in Figure \ref{fig:Jolly5}.

Similarly, if the left pair goes below the right pair, we will again have $\fbi$ tracing, as before. This is depicted in Figure \ref{fig:Jolly6}.
...
This is shown in Figure \ref{fig:Eager4}.
...
This is Figure \ref{fig:Eager9}.


Thus gonig back to the situation depicted in Figure \ref{fig:Eager3}, we must have $\fbb$ continue with $i^*$, and not $o^-$, and $\fbr$ will follow:
\[
\fbb = d s^- i^*...
\]
and
...
\fbr = d s^- i^*...
\]
This is Figure \ref{fig:Eager10}.
...
This is Figure \ref{fig:Eager11}.
...
This is Figure \ref{fig:Eager12}.
...
This is Figure \ref{fig:Global1}.
...
We are now in Figure \ref{fig:Global2}.
...
This is Figure \ref{fig:Balance1}.
...
This is Figure \ref{fig:Balance2}. 
...
This is Figure \ref{fig:Balance3}.
...
This is Figure \ref{fig:Balance4}.
...
This is Figure \ref{fig:Balance5}.
...
This is Figure \ref{fig:Balance6}.


Therefore going back to the situation depicted in Figure \ref{fig:Balance2}, $\fbp$ has to end there at $s^\circ$. 

This is Figure \ref{fig:Balance7}.
...
This is Figure \ref{fig:Balance8}.
...
Thus $\fbr$ must end at $p^\circ$ in the situation depicted in Figure \ref{fig:Balance8}.

This gives us Figure \ref{fig:Balance9}.
...
This gives Candidate 5. Depicted in Figure \ref{fig:Balance10}.


\subsubsubsubsubsection{Machine}\label{Machine}
Back to the end of Global \ref{Global}. Suppose
\[
\fbs = o^-...
\]

This is Figure \ref{fig:Machine1}.
...
This is Figure \ref{fig:Machine2}.
...
This is Figure \ref{fig:Machine3}.
...
\fbi = \dbar b^- d s^- o^- \dbar \hat{r}^+ d o^+ s^+ \dbar b^+ d o^-...
\]
This is Figure \ref{fig:Machine4}. 
...
This is Figure \ref{fig:Machine5}.
...
This is Figure \ref{fig:Machine6}.
...
This is Figure \ref{fig:Machine7}.
...
This is shown in Figure \ref{fig:Machine8}, where we have drawn both possibilities for $\fbs$.
...
This is Figure \ref{fig:Machine9}.
...
This is Figure \ref{fig:Fiasco1}.
...
This is Figure \ref{fig:Fiasco2}.
...
This is Figure \ref{fig:Fiasco3}.
...
\]
This is Figure \ref{fig:Fiasco4}.
...
This is Figure \ref{fig:Fiasco5}.
...
This is Figure \ref{fig:Fiasco6}.
...
This is Figure \ref{fig:Fiasco7}.
...
This is Figure \ref{fig:Fiasco8}.
...
Thus $\fbi$ can only continue with $b^-$, and then continue into 1, or 2 as depicted in Figure \ref{fig:Fiasco8}.
...
Therefore, we have established that in the situation depicted in Figure \ref{fig:Fiasco7}, $\fbi$ has to end at $r^\circ$:
\[
\fbi = \dbar b^- p^- b^+ d s^- o^- \dbar r^\circ
\]

This is Figure \ref{fig:Fiasco9}.
...
This is Figure \ref{fig:Fiasco10}.
...
This establishes the train track map Candidate 6 depicted in Figure \ref{fig:Fiasco1}.
...
The situation is depicted in Figure \ref{fig:ATL1}.
...
We are now in Figure \ref{fig:Jolt2}.
...
This is Figure \ref{fig:Jolt3}.

Now we are in Situation $\alpha$, in a clockwise manner.
...
We are in Figure \ref{fig:Mile3}.
...
\subsubsubsection{Night}\label{Night}
Suppose
\[
\fbo = r^*...
\]
...
This is Figure \ref{fig:Sizzle2}.
...
\fbr = \dbar p^+ d o^*...
\]
This is Figure \ref{fig:Sizzle3}.
...
This is Figure \ref{fig:Sizzle4}.

Now back to the situation in Figure \ref{fig:Sizzle2}, suppose $\fbp$ continues with $p^+$. Then $\fbr$ and $\fbb$ follow with $p^+$ as well. So we have:
\[
...
This is Figure \ref{fig:Sizzle5}.
...
\fbs = d \hat{o}^+ \dbar p^*...
\]
This is Figure \ref{fig:Sizzle6}.
...
This is Figure \ref{fig:Sizzle7}.
...
This is Figure \ref{fig:Sizzle8}.
...
This is Figure \ref{fig:Sizzle9}.

At this point, observe that we are repeating the pattern. That is, we are back in the situation depicted in Figure \ref{fig:Sizzle2}, but just with more twists.

In other words, here if $\fbi$ were to continue with $p^\circ$ then it will be a repeat of a previous case for Figure \ref{fig:Sizzle2}, but with more twists. If it continues with $p^+$ again then it repeats this process again but with more twists. It may however, continue here with $p^-$.

Therefore, it suffices now to eliminate the case of $\fbi$ continuing with $p^-$ in the situation depicted in Figure \ref{fig:Sizzle2}.

So consider the situation depicted in Figure \ref{fig:Sizzle2} once more, and let us consider the case when $\fbi$ continues with $p^-$.

This is Figure \ref{fig:Sizzle10}. Here it can go into 1, 2, or 3. If it goes into 1, then both $\fbr$ and $\fbb$ will continue with $p^+$ to the right of $\fbi$, which will make $\fbb$ trace:
\[
\fbb = \dbar p^+ d...
\]
...
This is Figure \ref{fig:Sizzle11}.
...
This is a contradiction. This eliminates the possibility of $\fbi$ continuing with $p^-$ in the situation depicted in Figure \ref{fig:Sizzle2}, and thereby eliminating the possibility of $p^+$ as well.

\subsubsubsubsubsection{Fleshy}\label{Fleshy}
...
This is Figure \ref{fig:Fleshy1}.

Here $\fbo$ can start with $b^-$ or $b^\circ$.

\subsubsubsubsubsubsection{Keyboard}\label{Keyboard}
Suppose
\[
\fbo = b^-...
\]
...
This is Figure \ref{fig:Keyboard1}.
...
So suppose $\fbo$ continues with $p^-$. This is Figure \ref{fig:Keyboard2}. Here it can continue into 1, 2, or 3. 
...
This is Figure \ref{fig:Keyboard3}.
...
This is Figure \ref{fig:Keyboard4}.
...
\]
This is Figure \ref{fig:Keyboard5}.
...
This is Figure \ref{fig:Keyboard6}.
...
This is Figure \ref{fig:Keyboard7}.
...
This is Figure \ref{fig:Keyboard8}.
...
This is Figure \ref{fig:Keyboard9}.
...
This is Figure \ref{fig:Keyboard10}.
...
This is Figure \ref{fig:Keyboard11}.
...
This is Figure \ref{fig:Keyboard12}.
...
This is Figure \ref{fig:Keyboard13}.


Now notice we have returned to the same situation as depicted in Figure \ref{fig:Keyboard7}, but simply with more twists. Notice we have $\fbb$ to the left of $\fbo$ on $p^*$, and $\fbr$ on $i^*$, exactly as they were in Figure \ref{fig:Keyboard7}. In particular, we can repeat all of the steps from that point on wards, except with additional twists added in for each mapping that appears in the argument. This process will then repeat indefinitely, and so none of the remaining edges have anywhere to end.

This is a contradiction.

So back to the situation depicted in Figure \ref{fig:Keyboard6}. Suppose $\fbp$ starts with $s^-$. Then we have
\[
\fbp = s^- i^*...
\]

This is Figure \ref{fig:Keyboard14}.
...
This is Figure \ref{fig:Keyboard15}.
...
This is Figure \ref{fig:Keyboard16}.
...
\fbb = \dbar b^\circ
\]
This is Figure \ref{fig:Keyboard17}.
...
This is Figure \ref{fig:Keyboard18}.
...
This is Figure \ref{fig:Keyboard19}.
...
\]
This is Figure \ref{fig:Keyboard20}.
...
This is Figure \ref{fig:Keyboard21}.

Now notice we are now repeating the situation depicted in Figure \ref{fig:Keyboard15}, except with more twists, and $\fbb$ having already ended at $p^\circ$. This means that the pattern repeats indefinitely, creating more twists, but never ends.

This is a contradiction.

Thus going back to the situation depicted in Figure \ref{fig:Keyboard16}, let us suppose $\fbb$ does not end at $p^\circ$ but instead continues with $p^-$. Then it continues:
\[
\fbb = \dbar p^- d s^- i^*...
\]

This is Figure \ref{fig:Keyboard22}.
...
This is Figure \ref{fig:Keyboard23}.
...
This is Figure \ref{fig:Keyboard25}.
...
This is Figure \ref{fig:Keyboard26}.
...
\]
This is Figure \ref{fig:Keyboard27}.
...
This is Figure \ref{fig:Keyboard28}.
...
Now we go back to the situation depicted in Figure \ref{fig:Keyboard24}. Let us consider the case when $\fbp$ ends at $s^\circ$. We will consider the case when it ends immediately after continuing with $i^-$, with the understanding that it could possibly have more twisting.

This situation is shown in Figure \ref{fig:Keyboard31}.
...
This is Figure \ref{fig:Keyboard32}.
...
This is Figure \ref{fig:Keyboard33}.
...
This is Figure \ref{fig:Briefing1}.
...
This is Figure \ref{fig:Briefing2}.
...
This is Candidate Family 7. Shown in Figure \ref{fig:Briefing2}.

Now let us go back to the situation depicted in Figure \ref{fig:Briefing1}, and suppose $\fbs$ continues with $o^\circ$. 
...
This is Figure \ref{fig:Briefing3}.
...
Now the next letter can be $i^*$ or $o^-$. If it were the former, then after some twisting, it must still eventually at some point continue with $o^-$ to not violate the Trace Lemma. So we have
\[
\fbdb = p^- d s^-...o^- \dbar...
\]

This is Figure \ref{fig:CDG4}.
...
This is shown in Figure \ref{fig:SYD1}.
...
This is depicted in Figure \ref{fig:SYD3}.

Thus $\fbdb$ cannot have initial twists. This is Figure \ref{fig:SYD4}.
...
This is depicted in Figure \ref{fig:SYD5}.

Therefore, the dotted lines, in the situation depicted in Figure \ref{fig:SYD1} must join. In this situation, $\fbs$ can continue with $i^*$ or $o^*$ after crossing:
\[
\fbs = d i^*...
\]
or
...
\subsubsubsection{Spend}\label{Spend}
Suppose
\[
\fbo = r^*...
\]

This is Figure \ref{fig:Spend1}.
...
\subsubsubsubsection{Jasper}\label{Jasper}
Suppose 
\[
\fbi = r^*...
\]
...
\fbp = i^- \dbar p^*...
\]
This is Figure \ref{fig:Jasper1}.
...
This is Figure \ref{fig:Jasper2}.

This is a contradiction.

\subsubsubsubsection{Fledge}\label{Fledge}
Back to the end of Acrid \ref{Acrid}. Suppose
\[
\fbi = b^*...
\]

This is Figure \ref{fig:Fledge1}.
...
This is Figure \ref{fig:Fledge2}.
...
This is Figure \ref{fig:Fledge3}. 
...
This is Figure \ref{fig:Quail4}. It then continues:
\[
\fbr = s^- \hat{i}^- \dbar p^+ b^*...
\]

This is Figure \ref{fig:Quail5}.
...
This is shown in Figure \ref{fig:Quail7}.
...
This is Figure \ref{fig:Quail10}.
...
This is Figure \ref{fig:Quail11}.
...
This is Figure \ref{fig:Quail12}.
...
Therefore, in the situation depicted in Figure \ref{fig:Quail8}, $\fbi$ must end at $p^\circ$. 

This is Figure \ref{fig:Quail13}.

This forms our train track map Candidate Family 9, where $\fbr$ and $\fbs$ as depicted in Figure \ref{fig:Quail13} can twist between $b$ and $o$ $k$ times but eventually they have to end there. 


Figure \ref{fig:Quail14} depicts this family with no such twists.


Figure \ref{fig:Quail15} depicts this family with one such twist. Notice that as soon as one of $\fbr$ or $\fbs$ ends, the other is forced to end as well, so they have to twist the same number of times.

This finishes the situation where $\fbo = r^\circ$. So going back to the situation depicted in Figure \ref{fig:Quail7}, suppose $\fbo$ does not end at $r$, then it has to start with $r^-$:
\[
\fbo = r^- p^*...
\]

This is Figure \ref{fig:Quail16}.
...
This is Figure \ref{fig:Quail17}.
...
This is Figure \ref{fig:Quail18}.
...
This is a contradiction. Thus in the situation depicted in Figure \ref{fig:Quail16}, $\fbo$ cannot continue with $p^+$ and thereby escape to the outer perimeter. This means that $\fbo$ can only end at $p$ or $r$, possibly with twists between the two. Moreover, we claim that $\fbi$ is also forced to twist among $p$ or $r$ and also end there (end at whichever one $\fbo$ does not end at). Indeed if $\fbi$ were to ever escape (possibly after some twisting), then we have the situation depicted in Figure \ref{fig:Quail19} (depicted with a couple twists before escaping).
...
Therefore, we have arrived at our next family of candidate train track maps, Candidate Family 10, as depicted in Figure \ref{fig:Quail20}. Here $\fbo$ and $\fbi$ twist $m$ times between $r$ and $p$ and end there, with twisting direction indicated by the arrows; and $\fbr$ and $\fbs$ twist $k$ times between $b$ and $o$, and end there, with twisting direction indicated by the arrows.
...
This is Figure \ref{fig:Imbue4}.

For simplicity, we will assume in the following arguments and diagrams that the initial twists of $\fbdb$ is minimal, i.e. one twist with $b$, as depicted in Figure \ref{fig:Imbue5}. The arguments will still work for any number of initial twists, except one has to add in more twists for any edge-path that traverses this region.

So consider the situation depicted in Figure \ref{fig:Imbue5}. Consider $\fbr$. It has to continue with $b^+$ and to the left of $\fbo$. Otherwise, $\fbo$ will be forced to continue with $b^-$ and to the right of $\fbr$, in which case it will be absorbed:
\[
...
This is Figure \ref{fig:Imbue8}.

Therefore we can conclude that $\fbdb$ cannot have any initial twists. Thus we must have the sitaution depicted in Figure \ref{fig:Imbue9}.
...
This is Figure \ref{fig:Zither1}.
...
This is Figure \ref{fig:Zither2}.
...
This is Figure \ref{fig:Abandon1}.
...
This is depicted in Figure \ref{fig:Jubilant1}.
...
This is Figure \ref{fig:Jubilant2}.

Here we have Candidate Family given by Figure \ref{fig:Jubilant2}, where $\fbr$ and $\fbb$ end at $p$ or $i$, after possibly $k$ twists between the two. In Figure \ref{fig:Jubilant3}, we have drawn the train track map from this family with one twist, in which case $\fbb$ ends at $p$, and $\fbr$ ends at $s$. 


This is Candidate Family 11.


Now suppose in the situation depicted in Figure \ref{fig:Jubilant1}, that $\fbp$ continues with $i^+$:
\[
\fbp = i^+ s^*...
\]
...
This is Figure \ref{fig:Jubilant4}.
...
This is Figure \ref{fig:Jubilant5}.
...
In Figure \ref{fig:Jubilant6}, we have depicted an example of a train track map from this family. In his example, $\fbp$ twists once, ending at $i$. On the other hand, $\fbb$ and $\fbr$ twist also once, so $\fbb$ does not end at $p$, but traverses to $s$ and end there; this forces $\fbr$ to continue with $s^-$ and traverse to $p$ to end there.

\subsubsubsubsubsubsection{Emergency} \label{Emergency}
Back to the end of Abandon \ref{Abandon}. Suppose $\fbs$ continues with $o^+$ (in the situation depicted in Figure \ref{fig:Abandon1}):
\[
\fbs = d \hat{o}^+ \dbar p^*...
\]

This is Figure \ref{fig:Emergency1}.

Here $\fbs$ can continue with $p^-$, $p^\circ$, or $p^+$.

\subsubsubsubsubsubsubsection{Landscape}\label{Landscape}
...
This is Figure \ref{fig:Landscape1}.
...
This is Figure \ref{fig:Treasure1}.
...
In Figure \ref{fig:Treasure2}, we have depicted a train track map from this family, where $\fbp$ twists once to end at $s$, and $\fbb$ and $\fbr$ twist once as well.

\subsubsubsubsubsubsubsection{Education}\label{Education}
...
This is Figure \ref{fig:Education1}.
...
In Figure \ref{fig:Education2} we have depicted an example train track map from this family..


This is 12 (combined with 11)

\subsubsubsubsubsection{Hapless}\label{Hapless}
...
This is Figure \ref{fig:Hapless1}.
...
This is Figure \ref{fig:Hapless2}.
...
This is Figure \ref{fig:Hapless3}.
...
Therefore, in the situation depicted in Figure \ref{fig:Hapless1}, we must have
\[
\fbs = d o^\circ
\]

This is Figure \ref{fig:Hapless4}.
...
This is Figure \ref{fig:Hapless5}.
...
This is Figure \ref{fig:Hapless6}.
...
This is Figure \ref{fig:Hapless7}.
...
This is Figure \ref{fig:Hapless8}.
...
\subsubsubsubsection{Unwary}\label{Unwary}
...
\fbi = r^+ d o^*...
\]
This is Figure \ref{fig:Unwary1}.
...
This is Figure \ref{fig:Unwary2}.
...
This is Figure \ref{fig:Unwary3}.
...
This is Figure \ref{fig:Unwary4}.
...
This is Figure \ref{fig:Unwary5}.
...
This is depicted in Figure \ref{fig:DXB1}.
...
This is Figure \ref{fig:DXB3}.

But now notice $\fbdb$ must continue with $s^+$ or $s^-$, both of which will cause it to violate the Trace Lemma, as the next letter will have to be $\dbar$ in both situations. 
...
\]
This is Figure \ref{fig:Zero1}. Here we are in a situation where $\fbdb$ continues to circle the outer perimeter counterclockwise and never ends. It cannot go up to $o^*$, as that would mean violating the Trace Lemma. 

This is a contradiction.

\subsubsection{Dome}\label{Dome}
Back to the end of DXB. Suppose $\fbdb$ continues with $o^*$. Then in fact it has to be $o^+$ and then $s^*$, otherwise it will violate the Trace Lemma:
\[
\fbdb = b^+ d \hat{o}^+ s^*...
\]
...
Then it must in fact be $i^+$ and to the left of $\fbr$ and $\fbb$ to not violate the Trace Lemma. It also must It then continues:
\[
\fbdb = r^+ d i^+ s^*...
\]

This is Figure \ref{fig:Corf1}.
...
This is Figure \ref{fig:Corf3}.

Here in order to not violate the Trace Lemma, $\fbdb$ must eventually traverse $r^+$ and cross d, possibly after some twisting between $b$ and $p$. But now $\fbdb$ will continue to traverse the outer perimeter counterclockwise, and will never be able to join with $\fbd$.

This is a contradiction.

\subsubsection{Woad}\label{Woad}
Back to the end of ARN \ref{ARN}. Suppose $\fbdb$ continues with $o^*$:
\[
\fbdb = r^+ d o^*...
\]

Then in fact it must continue with $o^+s^*...$ to not violate the Trace Lemma. 

This is Figure \ref{fig:Woad1}.

This situation is very similar to that depicted in Figure \ref{fig:Corf1}; and indeed here we can repeat the arguments of \ref{Corf}, starting with the situation depicted in Figure \ref{fig:Corf1}, to eventually conclude that $\fbdb$ must continue traversing indefinitely the outer perimeter countercloclwise.
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/AVX-1.jpg}
    \caption{AVX1}
    \label{fig:AVX1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/AVX-2.jpg}
    \caption{AVX2}
    \label{fig:AVX2}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Phil.jpg}
    \caption{Phil1}
    \label{fig:Phil1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Linen.jpg}
    \caption{Linen1}
    \label{fig:Linen1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Bibble.jpg}
    \caption{Bibble1}
    \label{fig:Bibble1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Bawcock.jpg}
    \caption{Bawcock1}
    \label{fig:Bawcock1}
\end{figure}
\clearpage
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Chaffer-1.jpg}
    \caption{Chaffer1}
    \label{fig:Chaffer1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Chaffer-2.jpg}
    \caption{Chaffer2}
    \label{fig:Chaffer2}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Chaffer-3.jpg}
    \caption{Chaffer3}
    \label{fig:Chaffer3}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Chaffer-4.jpg}
    \caption{Chaffer4}
    \label{fig:Chaffer4}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Fangle.jpg}
    \caption{Fangle1}
    \label{fig:Fangle1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Jargle.jpg}
    \caption{Jargle1}
    \label{fig:Jargle1}
\end{figure}
\clearpage
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Kench-1.jpg}
    \caption{Kench1}
    \label{fig:Kench1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Kench-2.jpg}
    \caption{Kench2}
    \label{fig:Kench2}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Test.jpg}
    \caption{Test1}
    \label{fig:Test1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Pugil.jpg}
    \caption{Pugil1}
    \label{fig:Pugil1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Limmer.jpg}
    \caption{Limmer1}
    \label{fig:Limmer1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Costard.jpg}
    \caption{Costard1}
    \label{fig:Costard1}
\end{figure}
\clearpage
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Daddock.jpg}
    \caption{Daddock1}
    \label{fig:Daddock1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Cordwain-1.jpg}
    \caption{Cordwain1}
    \label{fig:Cordwain1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Cordwain-2.jpg}
    \caption{Cordwain2}
    \label{fig:Cordwain2}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Loblolly-1.jpg}
    \caption{Loblolly1}
    \label{fig:Loblolly1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Loblolly-2.jpg}
    \caption{Loblolly2}
    \label{fig:Loblolly2}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Loblolly-3.jpg}
    \caption{Loblolly3}
    \label{fig:Loblolly3}
\end{figure}
\clearpage
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Smouch.jpg}
    \caption{Smouch1}
    \label{fig:Smouch1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Thwite.jpg}
    \caption{Thwite1}
    \label{fig:Thwite1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Quarl.jpg}
    \caption{Quarl1}
    \label{fig:Quarl1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Yaffle.jpg}
    \caption{Yaffle1}
    \label{fig:Yaffle1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/ACK.jpg}
    \caption{ACK1}
    \label{fig:ACK1}
\end{figure}
\clearpage
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Dram-1.jpg}
    \caption{Dram1}
    \label{fig:Dram1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Dram-2.jpg}
    \caption{Dram2}
    \label{fig:Dram2}
\end{figure}
\clearpage
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Sloom-1.jpg}
    \caption{Sloom1}
    \label{fig:Sloom1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Sloom-2.jpg}
    \caption{Sloom2}
    \label{fig:Sloom2}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Sloom-3.jpg}
    \caption{Sloom3}
    \label{fig:Sloom3}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Sloom-4.jpg}
    \caption{Sloom4}
    \label{fig:Sloom4}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Sloom-5.jpg}
    \caption{Sloom5}
    \label{fig:Sloom5}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Thrum.jpg}
    \caption{Thrum1}
    \label{fig:Thrum1}
\end{figure}
\clearpage
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Dwammy-1.jpg}
    \caption{Dwammy1}
    \label{fig:Dwammy1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Dwammy-2.jpg}
    \caption{Dwammy2}
    \label{fig:Dwammy2}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Dwammy-3.jpg}
    \caption{Dwammy3}
    \label{fig:Dwammy3}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Macarize.jpg}
    \caption{Macarize1}
    \label{fig:Macarize1}
\end{figure}
\clearpage
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Mooncalf-1.jpg}
    \caption{Mooncalf1}
    \label{fig:Mooncalf1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Mooncalf-2.jpg}
    \caption{Mooncalf2}
    \label{fig:Mooncalf2}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Mooncalf-3.jpg}
    \caption{Mooncalf3}
    \label{fig:Mooncalf3}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Mooncalf-4.jpg}
    \caption{Mooncalf4}
    \label{fig:Mooncalf4}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Mooncalf-5.jpg}
    \caption{Mooncalf5}
    \label{fig:Mooncalf5}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Mooncalf-6.jpg}
    \caption{Mooncalf6}
    \label{fig:Mooncalf6}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Mooncalf-7.jpg}
    \caption{Mooncalf7}
    \label{fig:Mooncalf7}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Mooncalf-8.jpg}
    \caption{Mooncalf8}
    \label{fig:Mooncalf8}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Mooncalf-9.jpg}
    \caption{Mooncalf9}
    \label{fig:Mooncalf9}
\end{figure}
\clearpage
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Faffel-1.jpg}
    \caption{Faffel1}
    \label{fig:Faffel1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Faffel-2.jpg}
    \caption{Faffel2}
    \label{fig:Faffel2}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Faffel-3.jpg}
    \caption{Faffel3}
    \label{fig:Faffel3}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Faffel-4.jpg}
    \caption{Faffel4}
    \label{fig:Faffel4}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Faffel-5.jpg}
    \caption{Faffel5}
    \label{fig:Faffel5}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Faffel-6.jpg}
    \caption{Faffel6}
    \label{fig:Faffel6}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Faffel-7.jpg}
    \caption{Faffel7}
    \label{fig:Faffel7}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Faffel-8.jpg}
    \caption{Faffel8}
    \label{fig:Faffel8}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Faffel-9.jpg}
    \caption{Faffel9}
    \label{fig:Faffel9}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Faffel-10.jpg}
    \caption{Faffel10}
    \label{fig:Faffel10}
\end{figure}
\clearpage
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Lugs-1.jpg}
    \caption{Lugs1}
    \label{fig:Lugs1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Lugs-2.jpg}
    \caption{Lugs2}
    \label{fig:Lugs2}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Haze-1.jpg}
    \caption{Haze1}
    \label{fig:Haze1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Haze-2.jpg}
    \caption{Haze2}
    \label{fig:Haze2}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Quip.jpg}
    \caption{Quip1}
    \label{fig:Quip1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Zest.jpg}
    \caption{Zest1}
    \label{fig:Zest1}
\end{figure}
\clearpage
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Omen-1.jpg}
    \caption{Omen1}
    \label{fig:Omen1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Omen-2.jpg}
    \caption{Omen2}
    \label{fig:Omen2}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Omen-3.jpg}
    \caption{Omen3}
    \label{fig:Omen3}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Omen-4.jpg}
    \caption{Omen4}
    \label{fig:Omen4}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Omen-5.jpg}
    \caption{Omen5}
    \label{fig:Omen5}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Omen-6.jpg}
    \caption{Omen6}
    \label{fig:Omen6}
\end{figure}
\clearpage
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Axe-1.jpg}
    \caption{Axe1}
    \label{fig:Axe1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Axe-2.jpg}
    \caption{Axe2}
    \label{fig:Axe2}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Axe-3.jpg}
    \caption{Axe3}
    \label{fig:Axe3}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Lox.jpg}
    \caption{Lox1}
    \label{fig:Lox1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Lava.jpg}
    \caption{Lava1}
    \label{fig:Lava1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Query.jpg}
    \caption{Query1}
    \label{fig:Query1}
\end{figure}
\clearpage
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Depth-1.jpg}
    \caption{Depth1}
    \label{fig:Depth1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Depth-2.jpg}
    \caption{Depth2}
    \label{fig:Depth2}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Depth-3.jpg}
    \caption{Depth3}
    \label{fig:Depth3}
\end{figure}
\clearpage
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Kiosk-1.jpg}
    \caption{Kiosk1}
    \label{fig:Kiosk1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Kiosk-2.jpg}
    \caption{Kiosk2}
    \label{fig:Kiosk2}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Kiosk-3.jpg}
    \caption{Kiosk3}
    \label{fig:Kiosk3}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Kiosk-4.jpg}
    \caption{Kiosk4}
    \label{fig:Kiosk4}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Kiosk-5.jpg}
    \caption{Kiosk5}
    \label{fig:Kiosk5}
\end{figure}
\clearpage
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Abacus-1.jpg}
    \caption{Abacus1}
    \label{fig:Abacus1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Abacus-2.jpg}
    \caption{Abacus2}
    \label{fig:Abacus2}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Abacus-3.jpg}
    \caption{Abacus3}
    \label{fig:Abacus3}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Abacus-4.jpg}
    \caption{Abacus4}
    \label{fig:Abacus4}
\end{figure}
\clearpage
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Banana-1.jpg}
    \caption{Banana1}
    \label{fig:Banana1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Banana-2.jpg}
    \caption{Banana2}
    \label{fig:Banana2}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Banana-3.jpg}
    \caption{Banana3}
    \label{fig:Banana3}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Cloud-1.jpg}
    \caption{Cloud1}
    \label{fig:Cloud1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Cloud-2.jpg}
    \caption{Cloud2}
    \label{fig:Cloud2}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Cloud-3.jpg}
    \caption{Cloud3}
    \label{fig:Cloud3}
\end{figure}
\clearpage
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Drop-1.jpg}
    \caption{Drop1}
    \label{fig:Drop1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Rage-1.jpg}
    \caption{Rage1}
    \label{fig:Rage1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Rage-2.jpg}
    \caption{Rage2}
    \label{fig:Rage2}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Lake-1.jpg}
    \caption{Lake1}
    \label{fig:Lake1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Join.jpg}
    \caption{Join1}
    \label{fig:Join1}
\end{figure}
\clearpage
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Jolly-1.jpg}
    \caption{Jolly1}
    \label{fig:Jolly1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Jolly-2.jpg}
    \caption{Jolly2}
    \label{fig:Jolly2}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Jolly-3.jpg}
    \caption{Jolly3}
    \label{fig:Jolly3}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Jolly-4.jpg}
    \caption{Jolly4}
    \label{fig:Jolly4}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Jolly-5.jpg}
    \caption{Jolly5}
    \label{fig:Jolly5}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Jolly-6.jpg}
    \caption{Jolly6}
    \label{fig:Jolly6}
\end{figure}
\clearpage
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Eager-01.jpg}
    \caption{Eager1}
    \label{fig:Eager1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Eager-02.jpg}
    \caption{Eager2}
    \label{fig:Eager2}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Eager-03.jpg}
    \caption{Eager3}
    \label{fig:Eager3}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Eager-04.jpg}
    \caption{Eager4}
    \label{fig:Eager4}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Eager-05.jpg}
    \caption{Eager5}
    \label{fig:Eager5}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Eager-06.jpg}
    \caption{Eager6}
    \label{fig:Eager6}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Eager-07.jpg}
    \caption{Eager7}
    \label{fig:Eager7}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Eager-08.jpg}
    \caption{Eager8}
    \label{fig:Eager8}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Eager-09.jpg}
    \caption{Eager9}
    \label{fig:Eager9}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Eager-10.jpg}
    \caption{Eager10}
    \label{fig:Eager10}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Eager-11.jpg}
    \caption{Eager11}
    \label{fig:Eager11}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Eager-12.jpg}
    \caption{Eager12}
    \label{fig:Eager12}
\end{figure}
\clearpage
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Global-1.jpg}
    \caption{Global1}
    \label{fig:Global1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Global-2.jpg}
    \caption{Global2}
    \label{fig:Global2}
\end{figure}
\clearpage
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Balance-1.jpg}
    \caption{Balance1}
    \label{fig:Balance1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Balance-2.jpg}
    \caption{Balance2}
    \label{fig:Balance2}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Balance-3.jpg}
    \caption{Balance3}
    \label{fig:Balance3}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Balance-4.jpg}
    \caption{Balance4}
    \label{fig:Balance4}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Balance-5.jpg}
    \caption{Balance5}
    \label{fig:Balance5}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Balance-6.jpg}
    \caption{Balance6}
    \label{fig:Balance6}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Balance-7.jpg}
    \caption{Balance7}
    \label{fig:Balance7}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Balance-8.jpg}
    \caption{Balance8}
    \label{fig:Balance8}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Balance-9.jpg}
    \caption{Balance9}
    \label{fig:Balance9}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Balance-10.jpg}
    \caption{Balance10}
    \label{fig:Balance10}
\end{figure}
\clearpage
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Machine-1.jpg}
    \caption{Machine1}
    \label{fig:Machine1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Machine-2.jpg}
    \caption{Machine2}
    \label{fig:Machine2}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Machine-3.jpg}
    \caption{Machine3}
    \label{fig:Machine3}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Machine-4.jpg}
    \caption{Machine4}
    \label{fig:Machine4}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Machine-5.jpg}
    \caption{Machine5}
    \label{fig:Machine5}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Machine-6.jpg}
    \caption{Machine6}
    \label{fig:Machine6}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Machine-7.jpg}
    \caption{Machine7}
    \label{fig:Machine7}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Machine-8.jpg}
    \caption{Machine8}
    \label{fig:Machine8}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Machine-9.jpg}
    \caption{Machine9}
    \label{fig:Machine9}
\end{figure}
\clearpage
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Iguana.jpg}
    \caption{Iguana1}
    \label{fig:Iguana1}
\end{figure}
\clearpage
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Fiasco-01.jpg}
    \caption{Fiasco1}
    \label{fig:Fiasco1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Fiasco-02.jpg}
    \caption{Fiasco2}
    \label{fig:Fiasco2}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Fiasco-03.jpg}
    \caption{Fiasco3}
    \label{fig:Fiasco3}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Fiasco-04.jpg}
    \caption{Fiasco4}
    \label{fig:Fiasco4}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Fiasco-05.jpg}
    \caption{Fiasco5}
    \label{fig:Fiasco5}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Fiasco-06.jpg}
    \caption{Fiasco6}
    \label{fig:Fiasco6}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Fiasco-07.jpg}
    \caption{Fiasco7}
    \label{fig:Fiasco7}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Fiasco-08.jpg}
    \caption{Fiasco8}
    \label{fig:Fiasco8}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Fiasco-09.jpg}
    \caption{Fiasco9}
    \label{fig:Fiasco9}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Fiasco-10.jpg}
    \caption{Fiasco10}
    \label{fig:Fiasco10}
\end{figure}
\clearpage
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/ATL.jpg}
    \caption{ATL1}
    \label{fig:ATL1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/LAX-1.jpg}
    \caption{LAX1}
    \label{fig:LAX1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Jolt-1.jpg}
    \caption{Jolt1}
    \label{fig:Jolt1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Jolt-2.jpg}
    \caption{Jolt2}
    \label{fig:Jolt2}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Jolt-3.jpg}
    \caption{Jolt3}
    \label{fig:Jolt3}
\end{figure}
\clearpage
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Mile-1.jpg}
    \caption{Mile1}
    \label{fig:Mile1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Mile-2.jpg}
    \caption{Mile2}
    \label{fig:Mile2}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Mile-3.jpg}
    \caption{Mile3}
    \label{fig:Mile3}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Night.jpg}
    \caption{Night1}
    \label{fig:Night1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Adieu.jpg}
    \caption{Adieu1}
    \label{fig:Adieu1}
\end{figure}
\clearpage
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Sizzle-01.jpg}
    \caption{Sizzle1}
    \label{fig:Sizzle1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Sizzle-02.jpg}
    \caption{Sizzle2}
    \label{fig:Sizzle2}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Sizzle-03.jpg}
    \caption{Sizzle3}
    \label{fig:Sizzle3}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Sizzle-04.jpg}
    \caption{Sizzle4}
    \label{fig:Sizzle4}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Sizzle-05.jpg}
    \caption{Sizzle5}
    \label{fig:Sizzle5}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Sizzle-06.jpg}
    \caption{Sizzle6}
    \label{fig:Sizzle6}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Sizzle-07.jpg}
    \caption{Sizzle7}
    \label{fig:Sizzle7}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Sizzle-08.jpg}
    \caption{Sizzle8}
    \label{fig:Sizzle8}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Sizzle-09.jpg}
    \caption{Sizzle9}
    \label{fig:Sizzle9}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Sizzle-10.jpg}
    \caption{Sizzle10}
    \label{fig:Sizzle10}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Sizzle-11.jpg}
    \caption{Sizzle11}
    \label{fig:Sizzle11}
\end{figure}
\clearpage
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Fleshy.jpg}
    \caption{Fleshy1}
    \label{fig:Fleshy1}
\end{figure}
\clearpage
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Keyboard-01.jpg}
    \caption{Keyboard1}
    \label{fig:Keyboard1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Keyboard-02.jpg}
    \caption{Keyboard2}
    \label{fig:Keyboard2}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Keyboard-03.jpg}
    \caption{Keyboard3}
    \label{fig:Keyboard3}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Keyboard-04.jpg}
    \caption{Keyboard4}
    \label{fig:Keyboard4}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Keyboard-05.jpg}
    \caption{Keyboard5}
    \label{fig:Keyboard5}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Keyboard-06.jpg}
    \caption{Keyboard6}
    \label{fig:Keyboard6}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Keyboard-07.jpg}
    \caption{Keyboard7}
    \label{fig:Keyboard7}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Keyboard-08.jpg}
    \caption{Keyboard8}
    \label{fig:Keyboard8}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Keyboard-09.jpg}
    \caption{Keyboard9}
    \label{fig:Keyboard9}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Keyboard-10.jpg}
    \caption{Keyboard10}
    \label{fig:Keyboard10}
\end{figure}

\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Keyboard-11.jpg}
    \caption{Keyboard11}
    \label{fig:Keyboard11}
\end{figure}

\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Keyboard-12.jpg}
    \caption{Keyboard12}
    \label{fig:Keyboard12}
\end{figure}

\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Keyboard-13.jpg}
    \caption{Keyboard13}
    \label{fig:Keyboard13}
\end{figure}

\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Keyboard-14.jpg}
    \caption{Keyboard14}
    \label{fig:Keyboard14}
\end{figure}

\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Keyboard-15.jpg}
    \caption{Keyboard15}
    \label{fig:Keyboard15}
\end{figure}

\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Keyboard-16.jpg}
    \caption{Keyboard16}
    \label{fig:Keyboard16}
\end{figure}

\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Keyboard-17.jpg}
    \caption{Keyboard17}
    \label{fig:Keyboard17}
\end{figure}

\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Keyboard-18.jpg}
    \caption{Keyboard18}
    \label{fig:Keyboard18}
\end{figure}

\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Keyboard-19.jpg}
    \caption{Keyboard19}
    \label{fig:Keyboard19}
\end{figure}

\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Keyboard-20.jpg}
    \caption{Keyboard20}
    \label{fig:Keyboard20}
\end{figure}

\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Keyboard-21.jpg}
    \caption{Keyboard21}
    \label{fig:Keyboard21}
\end{figure}

\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Keyboard-22.jpg}
    \caption{Keyboard22}
    \label{fig:Keyboard22}
\end{figure}

\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Keyboard-23.jpg}
    \caption{Keyboard23}
    \label{fig:Keyboard23}
\end{figure}

\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Keyboard-24.jpg}
    \caption{Keyboard24}
    \label{fig:Keyboard24}
\end{figure}

\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Keyboard-25.jpg}
    \caption{Keyboard25}
    \label{fig:Keyboard25}
\end{figure}

\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Keyboard-26.jpg}
    \caption{Keyboard26}
    \label{fig:Keyboard26}
\end{figure}

\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Keyboard-27.jpg}
    \caption{Keyboard27}
    \label{fig:Keyboard27}
\end{figure}

\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Keyboard-28.jpg}
    \caption{Keyboard28}
    \label{fig:Keyboard28}
\end{figure}

\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Keyboard-29.jpg}
    \caption{Keyboard29}
    \label{fig:Keyboard29}
\end{figure}

\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Keyboard-30.jpg}
    \caption{Keyboard30}
    \label{fig:Keyboard30}
\end{figure}

\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Keyboard-31.jpg}
    \caption{Keyboard31}
    \label{fig:Keyboard31}
\end{figure}

\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Keyboard-32.jpg}
    \caption{Keyboard32}
    \label{fig:Keyboard32}
\end{figure}

\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Keyboard-33.jpg}
    \caption{Keyboard33}
    \label{fig:Keyboard33}
\end{figure}
\clearpage

\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Briefing-1.jpg}
    \caption{Briefing1}
    \label{fig:Briefing1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Briefing-2.jpg}
    \caption{Briefing2}
    \label{fig:Briefing2}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Briefing-3.jpg}
    \caption{Briefing3}
    \label{fig:Briefing3}
\end{figure}
\clearpage
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/CDG-1.jpg}
    \caption{CDG1}
    \label{fig:CDG1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/CDG-2.jpg}
    \caption{CDG2}
    \label{fig:CDG2}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/CDG-3.jpg}
    \caption{CDG3}
    \label{fig:CDG3}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/CDG-4.jpg}
    \caption{CDG4}
    \label{fig:CDG4}
\end{figure}
\clearpage
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/SYD-1.jpg}
    \caption{SYD1}
    \label{fig:SYD1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/SYD-2.jpg}
    \caption{SYD2}
    \label{fig:SYD2}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/SYD-3.jpg}
    \caption{SYD3}
    \label{fig:SYD3}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/SYD-4.jpg}
    \caption{SYD4}
    \label{fig:SYD4}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/SYD-5.jpg}
    \caption{SYD5}
    \label{fig:SYD5}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Ride.jpg}
    \caption{Ride1}
    \label{fig:Ride1}
\end{figure}
\clearpage
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Spend-1.jpg}
    \caption{Spend1}
    \label{fig:Spend1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Spend-2.jpg}
    \caption{Spend2}
    \label{fig:Spend2}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Acrid.jpg}
    \caption{Acrid1}
    \label{fig:Acrid1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Jasper-1.jpg}
    \caption{Jasper1}
    \label{fig:Jasper1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Jasper-2.jpg}
    \caption{Jasper2}
    \label{fig:Jasper2}
\end{figure}
\clearpage
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Fledge-1.jpg}
    \caption{Fledge1}
    \label{fig:Fledge1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Fledge-2.jpg}
    \caption{Fledge2}
    \label{fig:Fledge2}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Fledge-3.jpg}
    \caption{Fledge3}
    \label{fig:Fledge3}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Clam.jpg}
    \caption{Clam1}
    \label{fig:Clam1}
\end{figure}
\clearpage
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Quail-01.jpg}
    \caption{Quail1}
    \label{fig:Quail1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Quail-02.jpg}
    \caption{Quail2}
    \label{fig:Quail2}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Quail-03.jpg}
    \caption{Quail3}
    \label{fig:Quail3}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Quail-04.jpg}
    \caption{Quail4}
    \label{fig:Quail4}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Quail-05.jpg}
    \caption{Quail5}
    \label{fig:Quail5}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Quail-06.jpg}
    \caption{Quail6}
    \label{fig:Quail6}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Quail-07.jpg}
    \caption{Quail7}
    \label{fig:Quail7}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Quail-08.jpg}
    \caption{Quail8}
    \label{fig:Quail8}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Quail-09.jpg}
    \caption{Quail9}
    \label{fig:Quail9}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Quail-10.jpg}
    \caption{Quail10}
    \label{fig:Quail10}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Quail-11.jpg}
    \caption{Quail11}
    \label{fig:Quail11}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Quail-12.jpg}
    \caption{Quail12}
    \label{fig:Quail12}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Quail-13.jpg}
    \caption{Quail13}
    \label{fig:Quail13}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Quail-14.jpg}
    \caption{Quail14}
    \label{fig:Quail14}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Quail-15.jpg}
    \caption{Quail15}
    \label{fig:Quail15}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Quail-16.jpg}
    \caption{Quail16}
    \label{fig:Quail16}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Quail-17.jpg}
    \caption{Quail17}
    \label{fig:Quail17}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Quail-18.jpg}
    \caption{Quail18}
    \label{fig:Quail18}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Quail-19.jpg}
    \caption{Quail19}
    \label{fig:Quail19}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Quail-20.jpg}
    \caption{Quail20}
    \label{fig:Quail20}
\end{figure}
\clearpage
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Imbue-1.jpg}
    \caption{Imbue1}
    \label{fig:Imbue1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Imbue-2.jpg}
    \caption{Imbue2}
    \label{fig:Imbue2}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Imbue-3.jpg}
    \caption{Imbue3}
    \label{fig:Imbue3}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Imbue-4.jpg}
    \caption{Imbue4}
    \label{fig:Imbue4}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Imbue-5.jpg}
    \caption{Imbue5}
    \label{fig:Imbue5}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Imbue-6.jpg}
    \caption{Imbue6}
    \label{fig:Imbue6}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Imbue-7.jpg}
    \caption{Imbue7}
    \label{fig:Imbue7}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Imbue-8.jpg}
    \caption{Imbue8}
    \label{fig:Imbue8}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Imbue-9.jpg}
    \caption{Imbue9}
    \label{fig:Imbue9}
\end{figure}
\clearpage
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Zither-1.jpg}
    \caption{Zither1}
    \label{fig:Zither1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Zither-2.jpg}
    \caption{Zither2}
    \label{fig:Zither2}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Abandon.jpg}
    \caption{Abandon1}
    \label{fig:Abandon1}
\end{figure}
\clearpage
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Jubilant-1.jpg}
    \caption{Jubilant1}
    \label{fig:Jubilant1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Jubilant-2.jpg}
    \caption{Jubilant2}
    \label{fig:Jubilant2}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Jubilant-3.jpg}
    \caption{Jubilant3}
    \label{fig:Jubilant3}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Jubilant-4.jpg}
    \caption{Jubilant4}
    \label{fig:Jubilant4}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Jubilant-5.jpg}
    \caption{Jubilant5}
    \label{fig:Jubilant5}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Jubilant-6.jpg}
    \caption{Jubilant6}
    \label{fig:Jubilant6}
\end{figure}
\clearpage
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Emergency.jpg}
    \caption{Emergency1}
    \label{fig:Emergency1}
\end{figure}

\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Landscape.jpg}
    \caption{Landscape1}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Treasure-1.jpg}
    \caption{Treasure1}
    \label{fig:Treasure1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Treasure-2.jpg}
    \caption{Treasure2}
    \label{fig:Treasure2}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Education-1.jpg}
    \caption{Education1}
    \label{fig:Education1}
\end{figure}

\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Education-2.jpg}
    \caption{Education2}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Hapless-1.jpg}
    \caption{Hapless1}
    \label{fig:Hapless1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Hapless-2.jpg}
    \caption{Hapless2}
    \label{fig:Hapless2}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Hapless-3.jpg}
    \caption{Hapless3}
    \label{fig:Hapless3}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Hapless-4.jpg}
    \caption{Hapless4}
    \label{fig:Hapless4}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Hapless-5.jpg}
    \caption{Hapless5}
    \label{fig:Hapless5}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Hapless-6.jpg}
    \caption{Hapless6}
    \label{fig:Hapless6}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Hapless-7.jpg}
    \caption{Hapless7}
    \label{fig:Hapless7}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Hapless-8.jpg}
    \caption{Hapless8}
    \label{fig:Hapless8}
\end{figure}
\clearpage
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Unwary-1.jpg}
    \caption{Unwary1}
    \label{fig:Unwary1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Unwary-2.jpg}
    \caption{Unwary2}
    \label{fig:Unwary2}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Unwary-3.jpg}
    \caption{Unwary3}
    \label{fig:Unwary3}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Unwary-4.jpg}
    \caption{Unwary4}
    \label{fig:Unwary4}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Unwary-5.jpg}
    \caption{Unwary5}
    \label{fig:Unwary5}
\end{figure}
\clearpage
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/DXB-1.jpg}
    \caption{DXB1}
    \label{fig:DXB1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/DXB-2.jpg}
    \caption{DXB2}
    \label{fig:DXB2}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/DXB-3.jpg}
    \caption{DXB3}
    \label{fig:DXB3}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/DXB-4.jpg}
    \caption{DXB4}
    \label{fig:DXB4}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/DXB-5.jpg}
    \caption{DXB5}
    \label{fig:DXB5}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Zero.jpg}
    \caption{Zero1}
    \label{fig:Zero1}
\end{figure}
\clearpage
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Dome-1.jpg}
    \caption{Dome1}
    \label{fig:Dome1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Dome-2.jpg}
    \caption{Dome2}
    \label{fig:Dome2}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Dome-3.jpg}
    \caption{Dome3}
    \label{fig:Dome3}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/PHX-1.jpg}
    \caption{PHX1}
    \label{fig:PHX1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/MIA.jpg}
    \caption{MIA1}
    \label{fig:MIA1}
\end{figure}
\clearpage
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/NRT-1.jpg}
    \caption{NRT1}
    \label{fig:NRT1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/NRT-2.jpg}
    \caption{NRT2}
    \label{fig:NRT2}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/NRT-3.jpg}
    \caption{NRT3}
    \label{fig:NRT3}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/ARN-1.jpg}
    \caption{ARN1}
    \label{fig:ARN1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/ARN-2.jpg}
    \caption{ARN2}
    \label{fig:ARN2}
\end{figure}
\clearpage
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Corf-1.jpg}
    \caption{Corf1}
    \label{fig:Corf1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Corf-2.jpg}
    \caption{Corf2}
    \label{fig:Corf2}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Corf-3.jpg}
    \caption{Corf3}
    \label{fig:Corf3}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/Woad-1.jpg}
    \caption{Woad1}
    \label{fig:Woad1}
\end{figure}
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\linewidth]{figures_case_analysis/track0_case_analysis/SIN.jpg}
    \caption{SIN1}
    \label{fig:SIN1}
\end{figure}
