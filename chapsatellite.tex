...
\begin{myproof}[Proof of Theorem \ref{theorem:satellite}]
    ...
    \]
    On the other hand, since $K$ is a fibered knot in $S^3$ and $S^3$ is an L-space, the theorem of Hedden and Mark\sidecite{hedden2018floer} bounds the fractional Dehn twist coefficient by
    \[
    |c(K)| \leq 1.
    \]
    ...
    The triple $(-Y_1(K),-Y,-Y_0(K))$ fits into a surgery exact triangle of Ozv\'{a}th-Szab\'{o}, with twisted coefficients on the $0$-surgery term (cf.\ Hedden-Mark\sidecite{hedden2018floer}, Section 5):
    \[
    ...
    By Proposition 2.4 of Hedden-Mark\sidecite{hedden2018floer}, non-triviality of $F$ on the $\mathfrak{s}_{1-g}$ summand implies that the contact invariant
    \[
    c(\xi_1) \in HF^+(-Y_1(K); \mathbb{F})
    \]
    is non-zero. By Theorem 1.4 of Ozv\'{a}th-Szab\'{o}\sidecite{ozsvath2004holomorphic}, this implies that $\xi_1$ is \emph{tight}.
